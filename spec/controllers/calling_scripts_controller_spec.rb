...
RSpec.describe CallingScriptsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested calling_script as @calling_script" do
      calling_script = CallingScript.create! valid_attributes
      get :show, params: {id: calling_script.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested calling_script as @calling_script" do
      calling_script = CallingScript.create! valid_attributes
      get :edit, params: {id: calling_script.to_param}, session: valid_session
      expect(assigns(:calling_script)).to eq(calling_script)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new CallingScript" do
        expect {
          post :create, params: {calling_script: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved calling_script as @calling_script" do
        post :create, params: {calling_script: invalid_attributes}, session: valid_session
        expect(assigns(:calling_script)).to be_a_new(CallingScript)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested calling_script" do
        calling_script = CallingScript.create! valid_attributes
        put :update, params: {id: calling_script.to_param, calling_script: new_attributes}, session: valid_session
      ...
      it "assigns the requested calling_script as @calling_script" do
        calling_script = CallingScript.create! valid_attributes
        put :update, params: {id: calling_script.to_param, calling_script: valid_attributes}, session: valid_session
        expect(assigns(:calling_script)).to eq(calling_script)
      end
    ...
    context "with invalid params" do
      it "assigns the calling_script as @calling_script" do
        calling_script = CallingScript.create! valid_attributes
        put :update, params: {id: calling_script.to_param, calling_script: invalid_attributes}, session: valid_session
        expect(assigns(:calling_script)).to eq(calling_script)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested calling_script" do
      calling_script = CallingScript.create! valid_attributes
      expect {
        delete :destroy, params: {id: calling_script.to_param}, session: valid_session
      }.to change(CallingScript, :count).by(-1)
    end
